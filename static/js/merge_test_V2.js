...
function addEpidemicInfo(startDate, endDate, epidemic) {
  ...
  d3.json(queryurl).then(function (data) {
    ...
    for (var i = 0; i < len; i++) {
      var text = ("Country: " + sorted_data[i]['country'] + "<br>" +
...
///////////////// Market Data Plots ////////////////
function getMarketData(startDate, endDate) {
...
submit.on("click", function () {
  ...
  // Plot Epidemic new info
  addEpidemicInfo(startDate, endDate, epidemic);

  // Add market plots
  getMarketData(startDate, endDate);
